...
<body>
<div class="header">
        <h1>Almacenamiento de usuarios</h1>
...
<div class="body">
    ...
    <?php foreach ($secciones as $seccion): ?>
        <input type="radio" name="seccion" required value="<?php echo $seccion['id']; ?>"> Sección <?php echo $seccion['nombre']; ?><br>
    <?php endforeach; ?>
    <br><br>
    <label>Contraseña</label><br>
    <input type="password" required name="password" maxlength="255">
    <br><br>
    ...
    <!-- Mostrar mensajes -->
    <?php
    if (isset($_GET['err'])) echo '<span class="error">Error al almacenar el registro</span>';
    if (isset($_GET['info'])) echo '<span class="success">Registro almacenado correctamente!</span>';
    ?>
</form>
